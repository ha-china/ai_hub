...
2. **配置 API Keys**: 按照向导提示依次配置以下服务：
   - 智谱 API Key（用于对话、AI任务、TTS、STT）
   - 硅基流动性 API Key（用于语音识别）
   - 巴法云API Key（用于微信消息推送）
...
#### 联网搜索
- **启用条件**: 在对话助手的高级模式中开启
- **功能**: 允许模型搜索网络信息以提供更准确的回答
- **注意**: 可能会增加响应时间

#### 多语言语音支持
AI Hub 支持 60+ 种语言的 400+ 种语音，包括：
- **中文**: 晓晓、晓伊、云健、云希、云霞、云扬（简体）、晓佳、晓雯、云龙（繁体）等
- **英文**: Jenny、Guy、Aria、Davis、Jane、Jason 等（美式、英式、澳式等）
- **其他**: 日文、韩文、法文、德文、西班牙文、意大利文等
